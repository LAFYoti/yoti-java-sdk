...
public class SandboxDocumentAuthenticityCheckBuilderTest {
    ...
    public void shouldRaiseExceptionWhenBreakdownListIsSetToNull() {
        try {
            new SandboxDocumentAuthenticityCheckBuilder().withRecommendation(SOME_RECOMMENDATION)
    ...
    public void shouldBuildWhenGivenOnlyRecommendation() {
        SandboxDocumentAuthenticityCheck result = new SandboxDocumentAuthenticityCheckBuilder().withRecommendation(SOME_RECOMMENDATION)
                .build();
