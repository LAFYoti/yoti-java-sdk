...
public class SandboxFaceMatchCheckBuilderTest {
    ...
    public void shouldRaiseExceptionWhenMissingRecommendation() {
        try {
            new SandboxFaceMatchCheckBuilder().build();
    ...
    public void shouldRaiseExceptionWhenBreakdownListIsSetToNull() {
        try {
            new SandboxFaceMatchCheckBuilder().withRecommendation(SOME_RECOMMENDATION)
    ...
    public void shouldBuildWhenGivenOnlyRecommendation() {
        SandboxFaceMatchCheck result = new SandboxFaceMatchCheckBuilder().withRecommendation(SOME_RECOMMENDATION)
                .build();
